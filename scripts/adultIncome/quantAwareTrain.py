...
model.qconfig = quantization.get_default_qat_qconfig('x86') # Might need to change for ARM 
fuse_modules(model)
...
torch.save(quantized_model.state_dict(), "../../models/quantized/quant_aware_train_adult.pth")
